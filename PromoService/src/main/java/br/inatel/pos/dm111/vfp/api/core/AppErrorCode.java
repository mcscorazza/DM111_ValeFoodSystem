...
public enum AppErrorCode {
    ...
    PROMO_NOT_FOUND("promo.not.found", "Promo was not found!", 404),
    INVALID_USER_TYPE("invalid.user.type", "Provided user is not supported for the current operation.", 403),

    INVALID_USER_CREDENTIALS("invalid.user.credentials", "Provided credentials are invalid.", 401),
    OPERATION_NOT_SUPPORTED("operation.not.supported", "Operation not supported by the given user type.", 403),

    INTERNAL_DB_COMMUNICATION_ERROR("internal.error", "Failed to communicate to DB.", 500);
