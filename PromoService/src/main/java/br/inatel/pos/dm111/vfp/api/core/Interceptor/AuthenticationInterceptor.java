...
public class AuthenticationInterceptor implements HandlerInterceptor {
    ...
    public AuthenticationInterceptor(JwtParser jwtParser, UserRepository repository, RestaurantRepository restaurantRepository) {
