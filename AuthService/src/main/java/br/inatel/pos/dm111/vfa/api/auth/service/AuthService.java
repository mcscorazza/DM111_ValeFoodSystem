...
import br.inatel.pos.dm111.vfa.persistance.user.User;
import br.inatel.pos.dm111.vfa.persistance.user.UserRepository;
...
import static br.inatel.pos.dm111.vfa.api.core.AppErrorCode.INVALID_USER_CREDENTIALS;
...
public class AuthService {
    ...
    public AuthResponse authenticate(AuthRequest req) throws ApiException {
        ...
        if(userOpt.isPresent()) {
            ...
            throw new ApiException(INVALID_USER_CREDENTIALS);
        }
    }
    ...
    private String generateToken(User user) {
        ...
        return Jwts.builder()
                ...
                .issuedAt(Date.from(now.plusSeconds(300)))
                .signWith(privateKey)
                .compact();
    }
